...
// @version      1.0.5
// @description  需要python。若用 mpv MPC 播放，可更新服务器观看进度。支持 Jellyfin。
// @description:zh-CN 需要python。若用 mpv MPC 播放，可更新服务器观看进度。支持 Jellyfin。
// @description:en  Require python. If you use mpv or MPC , will update watch history to emby server. Support Jellyfin.
// @author       Kjtsune
